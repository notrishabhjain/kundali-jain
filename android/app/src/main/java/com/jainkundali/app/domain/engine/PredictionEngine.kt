...
object PredictionEngine {
    ...
    fun generatePredictions(profile: UserProfile): List<LifeDomainPrediction> {
        ...
        val spirPred = when {
            ...
            gunasthana >= 4 ->
                "$nakshatraHi नक्षत्र की आध्यात्मिक प्रकृति और $dashaHi दशा का संयोग आपकी साधना के लिए श्रेष्ठ काल है। आप वर्तमान में $gunasthana वें गुणस्थान पर हैं — विशेष पूजन और स्वाध्याय से ५वें (देशविरत-श्रावक) गुणस्थान तक प्रगति संभव है। पंचम काल में मुनि-दीक्षा एवं उपरि गुणस्थान संभव नहीं — लक्ष्य सम्यग्दर्शन की दृढ़ता और देशव्रत-पालन है।"
            else ->
        ...
        // 7. After-death trajectory — bounded by Pañcham Kāla doctrine: mokṣa is impossible,
        // but uttam dev-gati / manuṣya-gati bandh is the achievable goal.
        ...
        val panchamKalaNote = "स्मरण रहे — पंचम काल में मोक्ष सम्भव नहीं, परन्तु सम्यग्दर्शन-पूर्वक उत्तम देव-गति या उत्तम मनुष्य-गति का बन्ध साधना से अवश्य संभव है।"
        val afterPred = when {
            gunasthana >= 4 && !mohaActive ->
                "$ayushyaEffect आप शुभ देव-गति या उत्तम मनुष्य-गति के आयुष्य का बंध कर रहे हैं। सम्यग्दर्शन की दृढ़ता और व्रत-पालन से यह बंध और शुभ होगा। $panchamKalaNote"
            dominantKarma == "Ayushya" ->
                "आयुष्य कर्म की प्रबलता के कारण जीवन की गति और परिस्थितियां तेज़ी से बदल सकती हैं। $dashaHi दशा में शुभ भावों का संकल्प अत्यंत महत्वपूर्ण है — वे ही अगले जन्म का बंध करते हैं। $panchamKalaNote"
            mohaActive && gunasthana <= 2 ->
                "$dominantHi कर्म और $dashaHi दशा के संयोग में कषाय और भोग की ओर झुकाव हो सकता है। यदि भाव शुद्ध न रहे, तो तिर्यंच-गति का बंध संभव है। नित्य संथारा-भावना और णमोकार जाप अनिवार्य है।"
            else ->
                "$ayushyaEffect परलोक की स्थिति वर्तमान भावों पर निर्भर है। $nakshatraHi नक्षत्र में धर्म-साधना से मनुष्य-गति या देव-गति का बंध होगा। ${sadhana.samanyaUpaya} को नित्य-नियम बनाएं। $panchamKalaNote"
        }
