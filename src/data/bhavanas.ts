...
export interface Bhavana {
  ...
  nameHindi: string;
  nameEn: string;
  /** Romanized Sanskrit name. Source: Master Engineering Specification §2.1 bhavanas.json */
  sanskritName: string;
  /** English name. Source: Master Engineering Specification §2.1 */
  englishName: string;
  /** Core reflection text in English. Source: Master Engineering Specification §2.1 */
  reflection: string;
  contemplationHindi: string;  // core insight to contemplate (Hindi)
...
export const BHAVANAS: Bhavana[] = [
  {
    ...
    sanskritName: 'Anitya',
    englishName: 'Impermanence',
    reflection: 'The physical body, assets, and material wealth vanish like dew.',
  ...
  },
  {
    ...
    sanskritName: 'Aśaraṇa',
    englishName: 'Helplessness',
    reflection: 'No external force can rescue one from death except the path of self-realization.',
  ...
  },
  {
    ...
    sanskritName: 'Saṃsāra',
    englishName: 'Transmigration',
    reflection: 'Wandering alone through endless cycles of birth and death.',
  ...
  },
  {
    ...
    sanskritName: 'Ekatva',
    englishName: 'Solitude of the Soul',
    reflection: 'The soul arrives alone and departs alone; it is solitary in existence.',
  ...
  },
  {
    ...
    sanskritName: 'Anyatva',
    englishName: 'Separateness',
    reflection: 'The soul is fundamentally distinct from the material body.',
  ...
  },
  {
    ...
    sanskritName: 'Aśuci',
    englishName: 'Impurity of the Body',
    reflection: 'The physical frame is made of impure things and is transient.',
  ...
  },
  {
    ...
    sanskritName: 'Āsrava',
    englishName: 'Influx',
    reflection: 'Contemplating the channels through which karma streams into the soul.',
  ...
  },
  {
    ...
    sanskritName: 'Saṃvara',
    englishName: 'Stoppage',
    reflection: 'Contemplating the methods to block the influx of karmic matter.',
  ...
  },
  {
    ...
    sanskritName: 'Nirjarā',
    englishName: 'Shedding',
    reflection: 'Reflecting on the methods to systematically burn and shed bound karmas.',
  ...
  },
  {
    ...
    nameEn: 'Loka Bhavana',
    sanskritName: 'Loka',
    englishName: 'Structure of the Universe',
    reflection: 'Reflecting on the layout, limits, and components of the cosmos.',
  ...
  },
  {
    ...
    sanskritName: 'Bodhidurlabha',
    englishName: 'Rarity of Enlightenment',
    reflection: 'Contemplating the difficulty of attaining right faith, knowledge, and conduct.',
  ...
  },
  {
    ...
    sanskritName: 'Dharma',
    englishName: 'The Path of Truth',
    reflection: 'Reflecting on the pure path of the Tirthankaras as the ultimate refuge.',
